 ...
 */
@Named
public class MetaDataRepoImpl implements IMetaDataRepo {

	/** The Constant LOG. */
	private static final Log LOG = LogWrapper.getLogger(MetaDataRepoImpl.class);
	...
	public MasterDataValidate validateMasterData(MasterDataValidate masterDataValidate) throws RestException {
		...
		MasterDataValidate[] response = null;
		...
		if (masterDataValidate != null) {
			...
			response = getRestResponse(masterDataValidateList, "tenant.metadata.uri", MasterDataValidate[].class);
