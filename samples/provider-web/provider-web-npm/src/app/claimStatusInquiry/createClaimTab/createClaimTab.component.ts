...
@Component({
  selector: 'app-create-claim-tab',
  templateUrl: './createClaimTab.component.html',
  styleUrls: ['./createClaimTab.component.scss']
})
export class CreateClaimTabComponent implements OnInit {
