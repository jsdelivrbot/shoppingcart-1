...
export interface EnrollmentInner {
    /**
     * The group ID should hold the value Enrollment
     */
    groupId?: EnrollmentInner.GroupIdEnum;
    attributeDetails?: models.AttributeDetailsMemberCoverage;
}
export declare namespace EnrollmentInner {
    enum GroupIdEnum {
        Enrollment,
    }
}
