...
export interface UpdatedEmergencyContactInner {
    /**
     * The group ID should hold the value Address Details.
     */
    groupId?: UpdatedEmergencyContactInner.GroupIdEnum;
    attributeDetails?: models.EmergencyContact;
    profileAttributesMeta?: models.EmergencyContactDetailsProfileAttributesMeta;
}
export declare namespace UpdatedEmergencyContactInner {
    enum GroupIdEnum {
        Address,
    }
}
