 ...
 */
export var EmergencyContactDetails;
(function (EmergencyContactDetails) {
    var RelationToMemberEnum;
    (function (RelationToMemberEnum) {
        RelationToMemberEnum[RelationToMemberEnum["Self"] = 'Self'] = "Self";
        RelationToMemberEnum[RelationToMemberEnum["Spouse"] = 'Spouse'] = "Spouse";
        RelationToMemberEnum[RelationToMemberEnum["Dependent"] = 'Dependent'] = "Dependent";
    })(RelationToMemberEnum = EmergencyContactDetails.RelationToMemberEnum || (EmergencyContactDetails.RelationToMemberEnum = {}));
})(EmergencyContactDetails || (EmergencyContactDetails = {}));
//# sourceMappingURL=EmergencyContactDetails.js.map