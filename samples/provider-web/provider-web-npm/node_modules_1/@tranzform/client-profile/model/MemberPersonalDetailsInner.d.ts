...
export interface MemberPersonalDetailsInner {
    /**
     * The group ID should hold the value Member Personal Details.
     */
    groupId?: MemberPersonalDetailsInner.GroupIdEnum;
    attributeDetails?: models.MemberPersonalDetails;
}
export declare namespace MemberPersonalDetailsInner {
    enum GroupIdEnum {
