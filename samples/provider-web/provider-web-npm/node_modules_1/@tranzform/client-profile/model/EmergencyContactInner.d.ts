...
export interface EmergencyContactInner {
    /**
     * The group ID should hold the value Emergency Contact Details.
     */
    groupId?: EmergencyContactInner.GroupIdEnum;
    attributeDetails?: models.EmergencyContactDetails;
}
export declare namespace EmergencyContactInner {
    enum GroupIdEnum {
        EmergencyContact,
    }
}
