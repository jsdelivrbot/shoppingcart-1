...
export interface SubscriberGroupInner {
    /**
     * The group ID should hold the value SubscriberGroup Details.
     */
    groupId?: SubscriberGroupInner.GroupIdEnum;
    attributeDetails?: models.SubscriberGroupAttributeDetails;
}
export declare namespace SubscriberGroupInner {
    enum GroupIdEnum {
        SubscriberGroup,
    }
}
