...
export interface SubscriberSubGroupInner {
    /**
     * The group ID should hold the value SubscriberSubGroup Details.
     */
    groupId?: SubscriberSubGroupInner.GroupIdEnum;
    attributeDetails?: models.SubscriberSubGroupAttributeDetails;
}
export declare namespace SubscriberSubGroupInner {
    enum GroupIdEnum {
        SubscriberSubGroup,
    }
}
