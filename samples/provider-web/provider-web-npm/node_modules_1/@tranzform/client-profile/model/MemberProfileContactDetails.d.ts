...
export interface MemberProfileContactDetails {
    /**
     * Group ID value to be saved.
     */
    groupId?: string;
    /**
     * The corresponding group name should be saved.
     */
    groupName?: string;
    attributeDetails?: models.UpdatedContactAttributeDetails;
    profileAttributesMeta?: models.UpdatedContactProfileAttributesMeta;
}
