...
export interface MemberDetailsInner {
    /**
    ...
    dateOfBirth?: string;
    /**
     * This record type can repeat multiple times based on the benefits associated with the member
     */
    benefitDetails?: Array<models.BenefitDetails>;
}
