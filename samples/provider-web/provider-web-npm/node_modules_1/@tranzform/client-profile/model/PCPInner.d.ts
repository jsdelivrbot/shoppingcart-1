...
export interface PCPInner {
    ...
    lastName?: string;
    /**
     * ZIP code of the member preferred address.
     */
    zip?: string;
    /**
     * State of the member preferred address.
     */
    state?: string;
    /**
     * City of the member preferred address.
     */
    city?: string;
    /**
     * For any update it will be always be against a single category (Medical or Dental) but members can be multiple.
     */
    attributedetails?: Array<models.PcpAttributeDetailsMap>;
}
