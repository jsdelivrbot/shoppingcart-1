...
export interface MemberPersonalDetailsProfileGroupsInner {
    /**
     * The group ID should hold the value Address Details.
     */
    groupId?: MemberPersonalDetailsProfileGroupsInner.GroupIdEnum;
    attributeDetails?: models.MemberPersonalDetailsData;
    profileAttributesMeta?: models.MemberPersonalProfileAttributesMeta;
}
export declare namespace MemberPersonalDetailsProfileGroupsInner {
    enum GroupIdEnum {
        Address,
    }
}
