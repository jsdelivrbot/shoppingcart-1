...
export interface UpdatedAddressInner {
    /**
     * The group ID should hold the value Address Details.
     */
    groupId?: UpdatedAddressInner.GroupIdEnum;
    attributeDetails?: models.UpdatedAddressAttributeDetails;
    profileAttributesMeta?: models.AddressProfileAttributesMeta;
}
export declare namespace UpdatedAddressInner {
    enum GroupIdEnum {
        Address,
    }
}
