...
export interface TemporaryContactDetails {
    /**
     * Unique ID assigned by the Tenant to the member; internal Member ID; not external facing.
     */
    tenantEnrollmentId?: string;
    /**
     * The subscriber (Policy, Contract, and so on) ID assigned to the subscriber.
     */
    subscriberId?: string;
    /**
     * current Email Id assigned to the specific member.
     */
    currentEmailId?: string;
    /**
     * current Phone number assigned to the specific member.
     */
    currentPhoneNumber?: string;
    /**
     * Newly updated (phone number and Email Id) contacted details.
     */
    contactDetails?: Array<models.TemporaryContactDetailsContactDetails>;
    statusInfoVO?: models.StatusInfoVO;
}
